class NoticiasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @noticia.save
        ...
        format.json { render action: 'show', status: :created, location: @noticia }
      else
  ...
  private
    ...
    def noticia_params
      params.require(:noticia).permit(:corresponsal_id, :titulo, :contenido, :ciudad, :provincia, :url_imagen_noticia, :seccion)
    end
end
